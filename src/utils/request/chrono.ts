...
export type ChronoContextInterface = ContextInterface<
...
export const processUrls: ChronoContextInterface['transformUrl'] = (url: string) => (
    `${endPoint}${url}`
);
...
export function processOptions(
    ...
    const csrftoken = getCookie('chrono-csrftoken');
...
export const processResponse: ChronoContextInterface['transformResponse'] = async (
    res,
) => {
...
export const processError: ChronoContextInterface['transformError'] = (
    res,
) => {
    let error: Error;
    if (res === 'network') {
